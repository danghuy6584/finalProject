  ...
  return (
    <div className='shadow-md w-full fixed top-0 left-0 '>
           <div className='md:flex items-center justify-between bg-[#447878] py-4 md:px-10 px-7'>
            ...
            <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-10 z-[10] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-12 bg-[#447878]' : 'top-[-490px]'}`}>
                {
                    Links.map((link) => (
                ...
                <Link to={'/Login'} className='btn bg-white text-[#447878] md:ml-8 font-semibold px-3 py-1 rounded duration-500 md:static'>LOGIN</Link>
            </ul>
           </div>
        </div>
  )
